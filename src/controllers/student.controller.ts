...
export class StudentController {
    ...
    */
    ...
    async createStudent(req: Request, res: Response): Promise<Response> {
        ...
        const createStudent = `SELECT createstudent($1,$2,$3,$4,$5,$6,$7,$8,$9);`;
        ...
        try {
            ...
            req.body.campus_code, req.body.profile, req.body.address, req.body.nationality,req.body.phone,req.body.email];
