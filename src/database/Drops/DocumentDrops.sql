...
DROP FUNCTION IF EXISTS createevaluationform;
DROP FUNCTION IF EXISTS deleteevaluationform;
DROP FUNCTION IF EXISTS getevaluationform;
DROP FUNCTION IF EXISTS getevaluationformperson;